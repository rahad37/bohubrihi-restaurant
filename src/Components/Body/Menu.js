    ...
    render(){
        ...
        if(this.props.dishes.isLoading){
            ...
            if(this.state.selectedDish != null){
                ...
                dishDetail = <DishDetail dish={this.state.selectedDish} comments={comments} addComment={this.props.addComment}commentsIsLoading={this.props.comments.isLoading}></DishDetail>
            }
            return(
